...
import { FaTint, FaWind, FaCompressAlt, FaEye } from "react-icons/fa";
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5">
        {stats.map((item, index) => (
          ...
          >
            ...
            <div
              className={`w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-gradient-to-br ${item.color} flex items-center justify-center text-white text-xl sm:text-2xl shadow-lg`}
            >
              {item.icon}
            </div>
