  ...
  return (
    ...
    >
      ...
      <img
        src={predictBg}
        alt=""
        className="absolute right-[-20px] lg:right-[-40px] top-0 h-full w-40 sm:w-48 lg:w-56 object-cover opacity-40 pointer-events-none select-none"
      />
  ...
  "
        >
          <div>
            ...
            <p
              className={`text-xl sm:text-2xl lg:text-3xl font-semibold mt-2 capitalize ${
